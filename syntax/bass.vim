...
\ , 'bassFn': ["dump","mkfs","json","log","logf","now","error","errorf","cons","wrap","unwrap","eval","make-scope","bind","meta","with-meta","null?","ignore?","boolean?","number?","string?","symbol?","scope?","sink?","source?","list?","pair?","applicative?","operative?","combiner?","path?","empty?","thunk?","+","*","quot","-","max","min","=",">",">=","<","<=","list->source","emit","next","reduce-kv","assoc","symbol->string","string->symbol","str","substring","trim","scope->list","string->fs-path","string->cmd-path","string->dir","subpath","path-name","with-image","with-dir","with-args","with-stdin","with-env","with-insecure","wrap-cmd","with-label","with-mount","thunk-cmd","load","resolve","run","succeeds?","read","recall-memo","store-memo","mask","list","list*","first","rest","length","second","third","map","map-pairs","apply","id","vals","keys","memo","foldr","foldl","merge","append","filter","conj","list->scope","last","take","str-thunk","insecure!","from","cd","mkfile","path-base","not"]
\ , 'bassOp': ["op","fn","current-scope","quote","let","import","provide","use","or","and","->","curryfn","$","linux"]
