...
\ , 'bassFn': ["dump","mkfs","json","log","error","now","cons","wrap","unwrap","eval","make-scope","bind","meta","with-meta","null?","ignore?","boolean?","number?","string?","symbol?","scope?","sink?","source?","list?","pair?","applicative?","operative?","combiner?","path?","empty?","thunk?","+","*","quot","-","max","min","=",">",">=","<","<=","list->source","across","emit","next","reduce-kv","assoc","symbol->string","string->symbol","str","substring","trim","scope->list","string->fs-path","string->cmd-path","string->dir","subpath","path-name","path-stem","with-image","with-dir","with-args","with-cmd","with-stdin","with-env","with-insecure","with-label","with-port","with-mount","thunk-cmd","thunk-args","load","resolve","start","addr","wait","read","cache-dir","binds?","recall-memo","store-memo","mask","list","list*","first","rest","length","second","third","map","map-pairs","foldr","foldl","append","filter","conj","list->scope","merge","apply","id","always","vals","keys","memo","succeeds?","run","last","take","insecure!","from","cd","wrap-cmd","mkfile","path-base","not"]
\ , 'bassOp': ["op","fn","current-scope","quote","let","import","provide","module","use","or","and","->","curryfn","when","for","$","linux"]
